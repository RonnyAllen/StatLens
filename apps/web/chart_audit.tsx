...
import { SurvivalChart } from './src/charts/SurvivalChart'
...
const routes: Record<string, any> = {
  ...
  'line-fit': undefined, 'km-step': SurvivalChart,
}
...
const surv: any = { type: 'Survival', columnGroups: [{id:'A',name:'A'},{id:'B',name:'B'}],
  data: [{'rowTitle': 10, A: 1, B: null}, {'rowTitle': 20, A: 0, B: 1}, {'rowTitle': 30, A: null, B: 1}] }
...
for (const [name, Comp] of Object.entries(routes)) {
  ...
  try {
    const sheetData = name === 'km-step' ? surv : col
    const h = renderToStaticMarkup(React.createElement(Comp, { sheet: sheetData, config: cfg, width: 800, height: 480, analysisResults: ar }))
