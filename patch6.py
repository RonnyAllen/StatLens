...
if 'elif test_id == "Log-rank Trend Test":' not in content:
    ...
    # Don't forget to update the `if test_id in (...):` list to include Log-rank Trend Test!
    content = content.replace(
        ...
        'if test_id in ("Survival Analysis", "Kaplan-Meier Survival Analysis", "Log-rank (Mantel-Cox) test", "Hazard Ratios", "Gehan-Breslow-Wilcoxon test", "Pairwise log-rank with Bonferroni/Šidák", "Cox Regression", "Log-rank Trend Test"):'
    )
